...
export const getClassNameForLink = (route) => {
    ...
    (route.activeOption)
        ? classNameForLink = `${classNameForLink} text-sky-400 before:bg-sky-400 hover:cursor-pointer`
        : classNameForLink = `${classNameForLink} text-slate-500 before:hidden before:bg-slate-300 hover:text-slate-300 hover:before:block hover:cursor-pointer`
